  ...
  return (
    <div className="container mx-auto">
      ...
      <table className="min-w-full border-collapse border border-gray-300">
        ...
        <tbody>
          {data
            .filter((item) => item.Current_Year === "1")
            //  .sort((a, b) => ((b.SGPA_1 + b.SGPA_2) / 2) - ((a.SGPA_1 + a.SGPA_2) / 2))
            .sort((a, b) => b.SGPA_1 - a.SGPA_1)
            .map((item, index) => (
              <tr key={index}>
                ...
                {/* <td className="px-6 py-4 whitespace-no-wrap border border-gray-300">{(item.SGPA_1 + item.SGPA_2)/2}</td>
              <td className="px-6 py-4 whitespace-no-wrap border border-gray-300">{((item.SGPA_1 + item.SGPA_2)/2)*10 } %</td> */}
